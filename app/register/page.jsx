              ...
              <div className="max-w-md mx-auto">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">
                    Register to access your dashboard and manage projects.
                  </p>
                </div>
                ...
                <form onSubmit={handleRegister} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full pl-3 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                      required
                    />
                  </div>
